...
export async function loader() {
  ...
  const sites = [{id: "10327500"}, {id: "10333000" }, {id: "10335000"}, {id: "10318500"}, {id: "10316500"},
  {id: "10325000"}, {id: "10322500"}, {id: "10321000"}, {id: "10320000"}, {id: "10319900"}];
  ...
  const monitors = [{id: "1310", name: "Lamoille Upper", loc: "NV"}, {id: "570", name: "Lamoille #3", loc: "NV"}, {id: "503", name: "Green Mountain", loc: "NV"}, {id: "417", name: "Corral Canyon", loc: "NV"},
  {id: "1243", name: "Dry Creek", loc: "NV"}, {id: "1244", name: "Pole Canyon", loc: "NV"}, {id: "527", name: "Hole-in-Mountain", loc: "NV"}, {id: "1202", name: "Tent Mtn Lower", loc: "NV"}, {id: "1211", name: "Jakes Creek", loc: "NV"},
  {id: "454", name: "Draw Creek", loc: "NV"}, {id: "1136", name: "Toe Jam", loc: "NV"}];
...
export default function Index() {
  ...
  <h3 className="text-lg font-medium mb-2">Humboldt River Basin Map</h3>
  <img src="https://d9-wret.s3.us-west-2.amazonaws.com/assets/palladium/production/s3fs-public/thumbnails/image/humboldt_webpage_map.png"></img>
</div>
<div className="bg-white rounded-lg p-6 shadow-md">
...
<div className="bg-white rounded-lg p-6 shadow-md">
  ...
  <a href="https://www.weather.gov/images/lkn/WxStory/WeatherStory1.png?edf3605e94abcc3e885a82bcef5fa060"><img src="https://www.weather.gov/images/lkn/WxStory/WeatherStory1.png?edf3605e94abcc3e885a82bcef5fa060"></img></a>
