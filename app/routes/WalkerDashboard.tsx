...
<div className="bg-white rounded-lg p-6 shadow-md">
  ...
  <p className="text-gray-600 mb-4"><a href="https://www.nrcs.usda.gov/Internet/WCIS/AWS_PLOTS/basinCharts/POR/WTEQ/assocHUCnv_8/walker.html">SNOTEL Walker Basin Graph</a></p>
  <p className="text-gray-600 mb-4"><a href="https://www.nrcs.usda.gov/Internet/WCIS/AWS_PLOTS/basinCharts/POR/WTEQ/assocHUCnv_8/eastern_nevada.html">SNOTEL Eastern Sierra Graph</a></p>
